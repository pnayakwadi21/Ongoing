...
INNER  JOIN  #EmployeeFinal em ON eh.Employee_Person_Ref=em.PERSON_REFERENCE
INNER JOIN 
...
--WHERE EMPLOYEE_PERSON_REFERENCE IN (01073628,
--01083444,
--01030905,
--01020595)
--AND EMPLOYEE_POST_END_DATE>GETDATE()
...
--SELECT * FROM dbo.REC_RESOURCELINK_ACTIVE_DIRECTORY
--WHERE EMPLOYEE_PERSON_REFERENCE IN (1073628	,
--1063805	,
--1087728	,
--1066242	,
--1083444	,
...
--)
--AND EMPLOYEE_POST_END_DATE>GETDATE()
--AND MANAGER_PERSON_REFERENCE IS   NULL


--SELECT * FROM [dbo].[DATASEGGREAGTION_RL_EMPLOYEE_DETAILS_DATASEG_VIEW]
--WHERE EMPLOYEE_USER_NAME LIKE '%doem%'


--SELECT * FROM  dbo.REC_RESOURCELINK_ACTIVE_DIRECTORY
--WHERE  EMPLOYEE_POST_REFERENCE=01010238


------01006484


----SELECT * FROM raw_d580m



--SELECT * FROM raw_d500m