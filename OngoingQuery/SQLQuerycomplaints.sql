...
/****** Object:  StoredProcedure [dbo].[DatixComplaints]    Script Date: 27/06/2022 15:53:04 ******/
SET ANSI_NULLS ON
GO
...
--DECLARE 	@StartDate VARCHAR(20)='2021/08/01',
--	@EndDate VARCHAR(20)='2021/09/10',
...
SELECT com_type,com_subject1 FROM dbo.compl_main  WITH (NOlock)
WHERE com_last_updated LIKE '%2021%'